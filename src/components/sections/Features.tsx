    ...
    <section id="solutions" className="py-32 bg-black/5 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-lg hover:bg-white/10 transition-colors group">
            <Brain className="w-12 h-12 text-purple-400 mb-6 transition-transform group-hover:scale-110" />
          ...
          <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-lg hover:bg-white/10 transition-colors group">
            <Sparkles className="w-12 h-12 text-green-400 mb-6 transition-transform group-hover:scale-110" />
