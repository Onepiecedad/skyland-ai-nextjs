        ...
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">👉</span> Talk to Dana to see what you could stop doing—starting today.
            </p>
          </div>
        </ContentStack>
      )
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">👉</span> Talk to Dana to see how fast clarity can replace chaos.
            </p>
          </div>
        </ContentStack>
      )
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">👉</span> Talk to Dana and take your first step into the after-AI era.
            </p>
          </div>
        </ContentStack>
      )
