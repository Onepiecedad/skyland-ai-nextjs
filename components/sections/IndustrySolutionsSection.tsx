        ...
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            <p className={cn(typography.text.base, colors.text.secondary)}>
              Real estate doesn't stop at 5 PM—but you do. Missed calls, unqualified leads, and
              non-stop questions pull you away from what really matters: closing deals.
            </p>
            ...
            <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                Your AI agent answers instantly—day or night—knows every listing in real time, and
                handles follow-ups without missing a beat.
              </p>
            </div>
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                Your AI support agent handles up to 80% of incoming questions instantly, 24/7—by
                voice or chat.
              </p>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                It works across channels, speaks multiple languages, and integrates directly into
                your CRM or helpdesk.
              </p>
            </div>

            <p className={cn(typography.text.base, colors.text.secondary, 'mt-4')}>
              No more ticket backlogs. No more missed calls. Just faster answers, happier customers,
              and a team that can finally breathe.
            </p>
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                Your AI concierge responds instantly by voice or chat, handles bookings, FAQs, and
                even upsells room upgrades or services automatically.
              </p>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                It works 24/7, speaks multiple languages, and connects with your existing booking
                system or CRM.
              </p>
            </div>
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                Your AI assistant handles repetitive tasks automatically—so you can focus on work
                that actually moves the needle.
              </p>
              <p className={cn(typography.text.base, colors.text.secondary)}>
                It updates systems, sends messages, reminds clients, tracks progress, and
      ...
      >
        <ContentStack spacing="md" className={cn(spacing.alignment.center)}>
          ...
          <p className={cn(typography.text.lg, colors.text.secondary, spacing.stack.md)}>
            From real estate to hospitality to customer support—AI is already handling the work that
