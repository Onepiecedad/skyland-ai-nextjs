      ...
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          <p className={cn(typography.text.base, colors.text.secondary)}>
            This 15-minute call is where your transformation starts. We'll walk through your daily
            workflows and identify what's costing you time, money, and momentum.
          </p>

          <p className={cn(typography.text.base, colors.text.secondary)}>
            You'll get expert insight into what's possible with AI—without the jargon or sales
            pitch. Just clarity, strategy, and next steps you can act on.
          </p>
  ...
  },
  {
    ...
    modalContent: (
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          <p className={cn(typography.text.base, colors.text.secondary)}>
            After the strategy call, you'll receive a tailored automation plan based on your
            workflows, goals, and biggest opportunities. No generic advice—just clear, actionable
            next steps.
          </p>
          ...
          <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
            ...
            <p className={cn(typography.text.base, colors.text.secondary)}>
              You'll know exactly what it costs, what it delivers, and how quickly it can go live—so
    ...
    modalContent: (
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Your custom AI system is built, trained, and configured to match your workflows, rules,
            and preferences. We handle the complexity—so you don't have to lift a finger.
          </p>
          ...
          <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
            <p className={cn(typography.text.base, colors.text.secondary)}>
              You'll preview the system, test it live, and make any final tweaks—so it works exactly
              how you want it.
            </p>
            <p className={cn(typography.text.base, colors.text.secondary)}>
    ...
    modalContent: (
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Every call, click, and conversation helps your AI improve accuracy, speed, and impact
            automatically.
          </p>
          ...
          <div className={cn(spacing.stack.sm, 'ml-2 border-l-2 border-blue-500/40 pl-4')}>
            <p className={cn(typography.text.base, colors.text.secondary)}>
              We monitor performance, refine workflows, and make smart updates—so your results keep
              compounding.
            </p>
            <p className={cn(typography.text.base, colors.text.secondary)}>
