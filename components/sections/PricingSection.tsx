  ...
  },
  {
    ...
    modalContent: (
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Skyland AI isn't a standard product—it's a custom solution built to generate measurable
            results.
          </p>
          ...
          <div className={cn(spacing.stack.sm, 'mt-4')}>
            ...
            <p className={cn(typography.text.base, colors.text.secondary)}>
              We design solutions around <strong>what your business stands to gain</strong>—not just
              what they cost.
            </p>
          </div>
          <p className={cn(typography.text.base, colors.text.accent, 'mt-4 flex items-center')}>
    ...
    modalContent: (
      <ContentStack spacing="md">
        ...
        <div className={cn(spacing.stack.md)}>
          ...
          <div className={cn(spacing.stack.sm, 'mt-4')}>
            <p className={cn(typography.text.base, colors.text.secondary)}>
              That's why we let you test your custom-built system for <strong>two weeks</strong>, in
              real conditions.
            </p>
            <p className={cn(typography.text.base, colors.text.secondary)}>
