        ...
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">💬</span> Talk to Dana to see how AI voice agents could work like 10 reps—on autopilot.
            </p>
          </div>
        </ContentStack>
      )
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">💬</span> Talk to Dana to see how a Custom AI Assistant could turn your traffic—and time—into revenue.
            </p>
          </div>
        </ContentStack>
      )
      ...
      expandedContent: (
        <ContentStack spacing="md">
          ...
          <div className={cn(spacing.stack.md)}>
            ...
            <p className={cn(typography.text.base, colors.text.accent, "mt-4 flex items-center")}>
              <span className="inline-block mr-2">💬</span> Talk to Dana to find out how much time (and sanity) you could save this week.
            </p>
          </div>
        </ContentStack>
      )
