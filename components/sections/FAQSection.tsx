  ...
  const faqs = [
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            Skyland AI builds tailored automation systems using AI. From voice agents and chatbots
            to workflow automation and lead qualification—we design intelligent tools to save you
            time and grow your business, fast.
          </p>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            We always start by identifying what's slowing you down—then we build a system that
            handles it.
          </p>
        </div>
      ),
    },
    {
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            It depends on what we build for you. There's no fixed pricing—just value-driven pricing
            based on your needs.
          </p>
          <p className={cn(typography.text.lg, colors.text.secondary, 'mt-4')}>
            Here's how it works:
          ...
          <ul className={cn(spacing.stack.md)}>
            ...
            <li>
              ...
              <strong>two full weeks, risk-free</strong>
            </li>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Our pricing model ensures you only pay for the value we deliver, making it a risk-free
    ...
    },
    {
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            After the strategy call, we build a working version tailored to your business. You test
            it in real conditions for two weeks—no sandbox, no fake data.
          </p>
          <p className={cn(typography.text.lg, colors.text.secondary, 'mt-4')}>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            This risk-free approach lets you see exactly what our AI solutions can do for your
            specific business before making a full commitment.
          </p>
        </div>
      ),
    },
    {
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            Plenty. From customer interactions to internal workflows, we can automate virtually any
            repetitive process that's eating up your time.
          </p>
          <p className={cn(typography.text.lg, colors.text.secondary, 'mt-4')}>
    ...
    },
    {
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            Very. Once your strategy call is done and the plan is approved, we usually deliver a
            working system within a few days.
          </p>
          <p className={cn(typography.text.lg, colors.text.secondary, 'mt-4')}>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Then you test it for two weeks and decide what's next. The entire process is designed to
    ...
    },
    {
      ...
      expandedContent: (
        <div className={cn(spacing.stack.lg)}>
          <p className={cn(typography.text.lg, colors.text.secondary)}>
            No—it makes them faster. Skyland AI doesn't replace people. It eliminates repetitive,
            low-value tasks so your team can focus on what matters.
          </p>
          <p className={cn(typography.text.lg, colors.text.secondary, 'mt-4')}>
          ...
          <p className={cn(typography.text.base, colors.text.secondary)}>
            Think of Skyland AI as giving your team superpowers—not replacing them. The goal is to
            make them more effective, not obsolete.
          </p>
        </div>
      ),
    },
