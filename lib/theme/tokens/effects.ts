export const effects = {
  interaction: {
    ...
    focus: {
      primary: "focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-opacity-50",
  ...
  hover: {
    ...
    premium: "hover:translate-y-[-4px] hover:shadow-xl hover:shadow-white/20 hover:border-white/20 transition-all duration-300"
  },
  transform: {
    rotate: {
  ...
  shadow: {
    ...
    premium: "shadow-lg shadow-white/10 hover:shadow-xl hover:shadow-white/20 transition-all duration-300"
  }
} as const; 